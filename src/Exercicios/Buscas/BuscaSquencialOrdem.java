...
class BuscaSequencialOrdem {
    public static int buscaSequencialOrdenada(int[] array, int valorProcurado){
    ...
    public static void main(String[] args) {
        ...
        int resultado1 = buscaSequencialOrdenada(vetor1, valorProcurado);
        imprimirResultado(resultado1);

        int resultado2 = buscaSequencialOrdenada(vetor2, valorProcurado);
        imprimirResultado(resultado2);

        int resultado3 = buscaSequencialOrdenada(vetor3, valorProcurado);
        imprimirResultado(resultado3);

        int resultado4 = buscaSequencialOrdenada(vetor4, valorProcurado);
